...
/// A custom set of date patterns for the `ln` locale.
///
...
/// A custom set of date symbols for the `ln` locale.
///
...
// #docregion Delegate
class _LnMaterialLocalizationsDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _LnMaterialLocalizationsDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'ln';

  @override
  Future<MaterialLocalizations> load(Locale locale) async {
    final String localeName = intl.Intl.canonicalizedLocale(locale.toString());

    // The locale (in this case `ln`) needs to be initialized into the custom
    // date symbols and patterns setup that Flutter uses.
    date_symbol_data_custom.initializeDateFormattingCustom(
      locale: localeName,
      //locale: "en",
      patterns: lnLocaleDatePatterns,
      symbols: intl.DateSymbols.deserializeFromMap(lnDateSymbols),
    );

    return SynchronousFuture<MaterialLocalizations>(
      LnMaterialLocalizations(
       // localeName: 'en',
  ...
  @override
  bool shouldReload(_LnMaterialLocalizationsDelegate old) => false;
}
// #enddocregion Delegate

/// A custom set of localizations for the 'ln' locale. In this example, only
/// the value for openAppDrawerTooltip was modified to use a custom message as
/// an example. Everything else uses the American English (en_US) messages
/// and formatting.
class LnMaterialLocalizations extends GlobalMaterialLocalizations {
  const LnMaterialLocalizations({
    super.localeName = 'ln',
...
// #enddocregion Raw
  ...
  _LnMaterialLocalizationsDelegate();
